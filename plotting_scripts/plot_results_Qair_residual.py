...
train_indices= list(range(0, 74))       
test_indices = list(range(74, 111))            
...
plt.xlabel("Time")
plt.ylabel("Qair residual (L/min)")
plt.legend()
#plt.savefig('/home/loesv/all_results/pileaute/Qair_residuals/CNN.png',  bbox_inches='tight', dpi=250)
#plt.savefig('/home/loesv/all_results/pileaute/Qair_residuals/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.show()
...
plt.tight_layout()
#plt.savefig('/home/loesv/all_results/pileaute/Qair_residuals/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
#plt.savefig('/home/loesv/all_results/pileaute/Qair_residuals/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.show()
