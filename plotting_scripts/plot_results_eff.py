...
y_true = df_avg['label_mean']+df['MechModelOutput']
y_predicted = df_avg['pred_mean']+df['MechModelOutput'].values
...
plt.legend()
plt.savefig('/home/loesv/all_results/pileaute/TSS_eff_residuals/CNN.png',  bbox_inches='tight', dpi=250)
#plt.savefig('/home/loesv/all_results/pileaute/TSS_eff_residuals/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pileaute/TSS_eff_residuals/CNN2.pdf', format="pdf", bbox_inches="tight", transparent=True, dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig('/home/loesv/all_results/pileaute/TSS_eff_residuals/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pileaute/TSS_eff_residuals/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.show()
