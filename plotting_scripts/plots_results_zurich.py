...
for folder in image_folders:
    subfolders=sorted(listdir(f"{images_base_folder}/{folder}"))
    temporary_pred=[]
    temporary_label=[]
    for subfolder in subfolders:
        path = f"{images_base_folder}/{folder}/{subfolder}"
...
# df=pd.read_csv('data/plant_zurich/SST_TSS.csv') #for mech model output
