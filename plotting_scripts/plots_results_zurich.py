...
plt.ylabel("TSS (mg/L)")
plt.legend()
plt.savefig('/home/loesv/all_results/zurich/TSS_eff/CNN.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/zurich/TSS_eff/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.show()
...
plt.tight_layout()
plt.savefig('/home/loesv/all_results/zurich/TSS_eff/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/zurich/TSS_eff/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.show()
