...
train_indices= list(range(0, 76))       
test_indices = list(range(76, 91))            

#plot time series
plt.rcParams.update({'font.size': 12})    
plt.figure(figsize=(14, 3), dpi=200)
plt.plot(y_true.iloc[:91], '.-', label='Measurements', color='blue')
...
plt.ylabel("SVI")
plt.legend()
plt.savefig('/home/loesv/all_results/pantarein/SVI/CNN.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pantarein/SVI/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.show()
...
plt.tight_layout()
plt.savefig('/home/loesv/all_results/pantarein/SVI/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pantarein/SVI/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.show()
