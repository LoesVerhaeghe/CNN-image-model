...
test_indices = list(range(78, 113))            
...
plt.ylabel("KLa (1/h)")
plt.legend()
plt.savefig('/home/loesv/all_results/pantarein/KLa/CNN.png',  bbox_inches='tight', dpi=250)
#plt.savefig('/home/loesv/all_results/pantarein/KLa/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pantarein/KLa/CNN2.pdf', format="pdf", bbox_inches="tight", transparent=True, dpi=300)
...
plt.tight_layout()
plt.savefig('/home/loesv/all_results/pantarein/KLa/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pantarein/KLa/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.show()
