...
output_path='output/bath/alpha_withDNAinput'
#output_path='output/bath/alpha'
...
train_indices1 = list(range(0, 4))
train_indices2= list(range(9, 21))  # 0–12 and 18–23
train_indices=list(range(0, 4))+list(range(9, 21))
test_indices = list(range(4, 9))  # 13–17
...
#plt.savefig('/home/loesv/all_results/bath/alpha_images/CNN.png',  bbox_inches='tight', dpi=250)
#plt.savefig('/home/loesv/all_results/bath/alpha_images/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/bath/alpha_imagesandDNA/CNN.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/bath/alpha_imagesandDNA/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.show()
...
plt.tight_layout()
#plt.savefig('/home/loesv/all_results/bath/alpha_images/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
#plt.savefig('/home/loesv/all_results/bath/alpha_images/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/bath/alpha_imagesandDNA/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/bath/alpha_imagesandDNA/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.show()
