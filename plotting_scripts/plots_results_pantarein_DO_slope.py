...
train_indices= list(range(0, 84))       
test_indices = list(range(84, 106))            

#plot time series
plt.rcParams.update({'font.size': 12})    
plt.figure(figsize=(14, 3), dpi=200)
plt.plot(y_true[:106], '.-', label='Measurements', color='blue')
...
plt.legend()
plt.savefig('/home/loesv/all_results/pantarein/DO_slope/CNN.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pantarein/DO_slope/CNN.pdf',  bbox_inches='tight', dpi=250)
plt.show()
...
plt.tight_layout()
plt.savefig('/home/loesv/all_results/pantarein/DO_slope/CNN_scatterplot.png',  bbox_inches='tight', dpi=250)
plt.savefig('/home/loesv/all_results/pantarein/DO_slope/CNN_scatterplot.pdf',  bbox_inches='tight', dpi=250)
plt.show()
