...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str, default= 'output/bath/v0_rh_5e4', help='Path for saving models and metrics')    
...
if __name__ == "__main__":
    ...
    train_dataset = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-11-19', end_folder='2021-12-15', label_path=args.labelpath, transform=train_transform) 
    train_dataset_2 = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-12-21', end_folder='2021-12-28', label_path=args.labelpath, transform=train_transform) 
 
    val_dataset = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-11-19', end_folder='2021-12-15', label_path=args.labelpath, transform=val_transform)   
    val_dataset_2 = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-12-21', end_folder='2021-12-28', label_path=args.labelpath, transform=val_transform)   
