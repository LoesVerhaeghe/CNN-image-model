...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str, default= 'output/bath/compression_params_withDNAinput', help='Path for saving models and metrics')    
...
if __name__ == "__main__":
    ...
    train_dataset = dataset_extrainputs.MicroscopicImagesBathCompression(root=args.imagedatapath, start_folder='2021-11-19', end_folder='2021-12-15', label_path=args.labelpath, extrainput_path=args.extrainputpath, transform=train_transform) 
    train_dataset_2 = dataset_extrainputs.MicroscopicImagesBathCompression(root=args.imagedatapath, start_folder='2021-12-21', end_folder='2021-12-28', label_path=args.labelpath, extrainput_path=args.extrainputpath,transform=train_transform) 
 
    val_dataset = dataset_extrainputs.MicroscopicImagesBathCompression(root=args.imagedatapath, start_folder='2021-11-19', end_folder='2021-12-15', label_path=args.labelpath, extrainput_path=args.extrainputpath, transform=val_transform)   
    val_dataset_2 = dataset_extrainputs.MicroscopicImagesBathCompression(root=args.imagedatapath, start_folder='2021-12-21', end_folder='2021-12-28', label_path=args.labelpath, extrainput_path=args.extrainputpath, transform=val_transform)   
    ...
    for fold, (train_index, val_index) in enumerate(kfold.split(idx)):
        ...
        if exists:
            ...
            # for epoch in range(args.epochs):  # loop over the dataset multiple times
                ...
                with torch.no_grad():
                    ...
                    for ii, data in enumerate(valloader, 0):
                        ...
                        loss = criterion(outputs, labels.to(output.dtype)) #no weighting loss during validation
            ...
            del model
            model = []        
            full_dataset = dataset_extrainputs.MicroscopicImagesBathCompression(root=args.imagedatapath, 
