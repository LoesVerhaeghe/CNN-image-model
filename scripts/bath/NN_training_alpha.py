...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str, default= 'output/bath/alpha', help='Path for saving models and metrics')    
...
if __name__ == "__main__":
    ...
    train_dataset = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-11-23', end_folder='2021-12-01', label_path=args.labelpath, transform=train_transform) 
    train_dataset_2 = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-12-14', end_folder='2021-12-28', label_path=args.labelpath, transform=train_transform) 
 
    val_dataset = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-11-23', end_folder='2021-12-01', label_path=args.labelpath, transform=val_transform)   
    val_dataset_2 = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, start_folder='2021-12-14', end_folder='2021-12-28', label_path=args.labelpath, transform=val_transform)   
    ...
    for fold, (train_index, val_index) in enumerate(kfold.split(idx)):
        ...
        if exists:
            ...
            del model
            model = []        
            full_dataset = dataset_bath.MicroscopicImagesBath(root=args.imagedatapath, 
