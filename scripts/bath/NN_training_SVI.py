...
def parse_args():
    ...
    parser.add_argument('--labelpath', type=str, default= 'data/bath/SVI_interpolated.csv', help='Path to load the labels')
    parser.add_argument('--output_path', type=str, default= 'output/bath/SVI', help='Path for saving models and metrics')    
