...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str, default= 'output/pantarein/do_slope', help='Path for saving models and metrics')    
...
if __name__ == "__main__":
    ...
    train_dataset = dataset_pantarein.MicroscopicImagesPantarein(root=args.imagedatapath, start_folder='2021-01-04', end_folder='2022-06-08', label_path=args.labelpath, transform=train_transform) 
    ...
    val_dataset = dataset_pantarein.MicroscopicImagesPantarein(root=args.imagedatapath, start_folder='2021-01-04', end_folder='2022-06-08', label_path=args.labelpath, transform=val_transform)   
