...
def parse_args():
    ...
    parser.add_argument('--labelpath', type=str, default= 'data/pileaute/beluchting/Qair_residuals_total_interpolated.csv', help='Path to load the labels')
    parser.add_argument('--output_path', type=str, default= 'output/pileaute/Qairres', help='Path for saving models and metrics')    
    ...
    parser.add_argument('--target', type=str, default='Qair_res', help='Target to train on')
...
if __name__ == "__main__":
    ...
    train_dataset = dataset_pileaute.MicroscopicImagesPileaute(root=args.imagedatapath, magnification=10, start_folder='2023-10-17', end_folder='2024-10-08', label_path=args.labelpath, transform=train_transform) 
    ...
    val_dataset = dataset_pileaute.MicroscopicImagesPileaute(root=args.imagedatapath, magnification=10, start_folder='2023-10-17', end_folder='2024-10-08', label_path=args.labelpath, transform=val_transform)   
