...
def parse_args():
    ...
    parser.add_argument('--labelpath', type=str, default= 'data/pileaute/settler_data/all/rh_interpolated_all.csv', help='Path to load the labels')
    parser.add_argument('--output_path', type=str, default= 'output/pileaute/rH/rH_LR1e4', help='Path for saving models and metrics')    
    ...
    parser.add_argument('--target', type=str, default='rH', help='Target to train on')
...
if __name__ == "__main__":
    ...
    train_dataset = dataset_pileaute.MicroscopicImagesPileaute(root=args.imagedatapath, magnification=10, start_folder='2023-10-13', end_folder='2024-08-28', label_path=args.labelpath, transform=train_transform) 
    ...
    val_dataset = dataset_pileaute.MicroscopicImagesPileaute(root=args.imagedatapath, magnification=10, start_folder='2023-10-13', end_folder='2024-08-28', label_path=args.labelpath, transform=val_transform)   
